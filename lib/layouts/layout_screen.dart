...
import 'package:todo/pages/Task_pages/addTaskPage.dart';
import 'package:todo/pages/Task_pages/cubit/cubit.dart';
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(
                         ...
                         if(AddTaskCubit.get(context).tasks.length==0)
                           noTaskMsg(context),
                         Expanded(
                            child: ListView.separated(
                                itemBuilder: (context, index) => Tasktile(
                                    context,
                                    AddTaskCubit.get(context).tasks[index]),
